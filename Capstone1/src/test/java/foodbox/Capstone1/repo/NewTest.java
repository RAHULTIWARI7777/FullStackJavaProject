package foodbox.Capstone1.repo;
...
public class NewTest {
    ...
    String driverPath = "C:\\\\Users\\\\www.abcom.in\\\\Downloads\\\\Capstone1\\\\target\\\\Driver\\\\chromedriver.exe";
    ...
    @Test(priority=0) public void login_Pass() {
		 ...
		 driver.findElement(By.name("email")).sendKeys("pragati@gmail.com");
		  ...
		  String actualUrl="http://localhost:8089";
    ...
    @Test(priority=1) public void viewProduct() {
		 ...
		 //view product Button
		  ...
		  String actualUrl="http://localhost:8089/shop/viewproduct/";
		  String expectedUrl= driver.getCurrentUrl();
		  if(actualUrl.equalsIgnoreCase(expectedUrl)) {
    ...
    @Test(priority=2) public void AddProduct() {
		 driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
		 driver.get("http://localhost:8089/shop/viewproduct/8");
		 
		  //view product Button
		  driver.findElement(By.xpath("/html/body/div/div/div[2]/a")).click();
		  String actualUrl="http://localhost:8089/shop";
		  String expectedUrl= driver.getCurrentUrl();
		  if(actualUrl.equalsIgnoreCase(expectedUrl)) {
    ...
    @Test(priority=3) public void register_Pass() {
		 driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
		 driver.get("http://localhost:8089/register");
		 driver.findElement(By.name("firstName")).sendKeys("Sachin");
		  driver.findElement(By.name("lastName")).sendKeys("pandey");
		  driver.findElement(By.name("email")).sendKeys("rahultiwari8799@gmail.com");
    ...
    @Test(priority=4) public void searchThroughKeyword() {
		 ...
		 driver.findElement(By.name("keyword")).sendKeys("jale");
		  ...
		  String actualUrl="http://localhost:8089/?keyword=jale";
		  String expectedUrl= driver.getCurrentUrl();
		  if(actualUrl.equalsIgnoreCase(expectedUrl)) {
